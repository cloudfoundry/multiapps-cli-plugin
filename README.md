...
# MultiApps CF CLI Plugin [![Build Status](https://travis-ci.org/cloudfoundry/multiapps-cli-plugin.svg?branch=master)](https://travis-ci.org/cloudfoundry/multiapps-cli-plugin)
This is a Cloud Foundry CLI plugin (formerly known as CF MTA Plugin) for performing operations on [multi-target applications (MTAs)](https://www.sap.com/documents/2016/06/e2f618e4-757c-0010-82c7-eda71af511fa.html) in Cloud Foundry, such as deploying, removing, viewing, etc. It is a client for the [CF MultiApps Controller](https://github.com/cloudfoundry/multiapps-controller) (formerly known as CF MTA deploy-service), which is an MTA deployer implementation for Cloud Foundry.
...
- Working [CF MultiApps Controller](https://github.com/cloudfoundry/multiapps-controller) - this a CF plugin for the MultiApps Controller application. Thus, a working MultiApps Controller must be available on the CF landscape
...
### Download
The latest version of the plugin can also be downloaded from the project's [releases](https://github.com/cloudfoundry/multiapps-cli-plugin/releases/latest/). Download the plugin for your platform (Darwin, Linux, Windows).


Mac OS X 64 bit | Windows 32 bit | Windows 64 bit | Linux 32 bit | Linux 64 bit
--- | --- | --- | --- | ---
[multiapps-plugin.osx](https://github.com/cloudfoundry/multiapps-cli-plugin/releases/latest/download/multiapps-plugin.osx) | [multiapps-plugin.win32.exe](https://github.com/cloudfoundry/multiapps-cli-plugin/releases/latest/download/multiapps-plugin.win32.exe) | [multiapps-plugin.win64.exe](https://github.com/cloudfoundry/multiapps-cli-plugin/releases/latest/download/multiapps-plugin.win64.exe) | [multiapps-plugin.linux32](https://github.com/cloudfoundry/multiapps-cli-plugin/releases/latest/download/multiapps-plugin.linux32) | [multiapps-plugin.linux64](https://github.com/cloudfoundry/multiapps-cli-plugin/releases/latest/download/multiapps-plugin.linux64)
...
*WARNING* : with [Issue 117](https://github.com/cloudfoundry/multiapps-cli-plugin/issues/117) the master branch of this repository as well as other artifacts will be renamed. Adaptation to any CI/CD infrastructure & scritps will be required.

## Cloning the repository
To clone the project in your Go workspace `$GOPATH/src/github.com/cloudfoundry/multiapps-cli-plugin` execute the following commands:
```
mkdir -p $GOPATH/src/github.com/cloudfoundry
cd $GOPATH/src/github.com/cloudfoundry
git clone git@github.com:cloudfoundry/multiapps-cli-plugin.git
```
...
This project is licensed under the Apache Software License, v. 2 except as noted otherwise in the [LICENSE](https://github.com/cloudfoundry/multiapps-cli-plugin/blob/master/LICENSE) file.
